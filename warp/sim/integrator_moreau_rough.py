    ...
    def _simulate_bundle(
        ...
        wp.launch(
            ...
            inputs=[
                ...
                model.joint_X_p, model.joint_X_cm, model.joint_axis, model.joint_axis_start,
            ],
        ...
        wp.launch(
            ...
            inputs=[
                ...
                model.joint_axis, model.joint_axis_start, model.joint_target_ke, model.joint_target_kd,
